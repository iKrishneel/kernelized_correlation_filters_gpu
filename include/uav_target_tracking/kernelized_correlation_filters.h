...
#include <uav_target_tracking/crop_feature_space.h>
#include <uav_target_tracking/loss_target_pursuit.h>
...
#include <uav_target_tracking/tracking_target_detector.h>
