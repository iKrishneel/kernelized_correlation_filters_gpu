...
void ComputeCropPadImageLocation(const BoundingBox2D& bbox_tight, const cv::Mat& image, BoundingBox2D* pad_image_location) {
...
void CropPadImage(const BoundingBox2D& bbox_tight, const cv::Mat& image, cv::Mat* pad_image) {
  BoundingBox2D pad_image_location;
...
void CropPadImage(const BoundingBox2D& bbox_tight, const cv::Mat& image, cv::Mat* pad_image,
                  BoundingBox2D* pad_image_location, double* edge_spacing_x, double* edge_spacing_y) {
